...
export default function Login() {
  ...
  const t = {
    fr: {
      ...
      switchToSignup: "Pas encore inscrit ?",
      switchToLogin: "Déjà inscrit ?",
      switchLinkSignup: "Créer un compte",
      switchLinkLogin: "Se connecter",
    ...
    en: {
      ...
      switchToSignup: "Not registered yet?",
      switchToLogin: "Already have an account?",
      switchLinkSignup: "Create an account",
        ...
        <div className="w-full max-w-sm py-16">
          ...
          <div className="border border-gray-200 rounded-2xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <button
                type="submit"
                className="w-full bg-gray-900 text-white py-3 rounded-xl text-sm font-medium hover:opacity-80 transition mt-2"
              >
            ...
            {/* Google */}
            <button
              onClick={() => { setMessage(copy.comingSoon); setMessageType("info"); }}
