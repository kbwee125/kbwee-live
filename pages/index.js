  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-gray-900" style={{fontFamily: "'DM Sans', sans-serif"}}>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 flex items-center justify-between px-8 h-16">
        <span className="font-syne text-xl font-extrabold tracking-tight">Kbwee</span>
      ...
      <main className="flex-grow flex flex-col items-center justify-center text-center px-6 pt-32 pb-20">
        ...
        <div className="flex gap-16 flex-wrap justify-center">
          <div className="text-center">
            <div className="font-syne text-3xl font-extrabold tracking-tight">94%</div>
            <div className="text-xs text-gray-400 mt-1">Satisfaction candidats</div>
          </div>
          <div className="text-center">
            <div className="font-syne text-3xl font-extrabold tracking-tight">3×</div>
            <div className="text-xs text-gray-400 mt-1">Plus rapide qu'un recrutement classique</div>
          </div>
          <div className="text-center">
            <div className="font-syne text-3xl font-extrabold tracking-tight">0 BS</div>
            <div className="text-xs text-gray-400 mt-1">Pas de feed social</div>
          </div>
        </div>
      </main>

      {/* SPLIT : Candidat / Recruteur */}
      <section className="grid md:grid-cols-2">
        ...
        <div className="bg-gray-50 border-r border-gray-200 px-16 py-20">
          ...
          <h2 className="font-syne text-4xl font-extrabold tracking-tight leading-tight mb-4">
          ...
          <ul className="space-y-3 mb-10">
            {["CV Optimizer IA — restructuration selon le poste visé", "LinkedIn Score — optimisation section par section", "Mock Interview — entraîne-toi, reçois un feedback IA", "Job Match — offres alignées avec ton vrai profil"].map((item, i) => (
              <li key={i} className="flex items-start gap-3 text-sm">
                <span className="mt-0.5 w-5 h-5 rounded-md bg-blue-100 flex items-center justify-center flex-shrink-0 text-blue-600 font-bold">✓</span>
        ...
        <div className="bg-gray-900 px-16 py-20">
          ...
          <h2 className="font-syne text-4xl font-extrabold tracking-tight leading-tight mb-4 text-white">
          ...
          <ul className="space-y-3 mb-10">
            {["Interview Kit IA — grilles d'entretien par poste", "Candidate Insights — fiche synthèse IA par candidat", "Bias Checker — recrutement équitable et objectif", "Fit Score — compatibilité candidat ↔ culture/poste"].map((item, i) => (
              <li key={i} className="flex items-start gap-3 text-sm text-gray-300">
                <span className="mt-0.5 w-5 h-5 rounded-md bg-blue-900 flex items-center justify-center flex-shrink-0 text-blue-400 font-bold">✓</span>
      ...
      <section className="py-24 px-8 max-w-5xl mx-auto w-full">
        ...
        <h2 className="font-syne text-4xl font-extrabold tracking-tight text-center mb-4">Comment ça marche ?</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { num: "01", title: "Crée ton profil", desc: "Importe ton CV ou LinkedIn. Kbwee l'analyse, le score, et te suggère comment le renforcer." },
            { num: "02", title: "Trouve le bon fit", desc: "Notre algorithme te connecte avec des offres alignées avec tes compétences et ta culture." },
            { num: "03", title: "Décroche l'entretien", desc: "Entraîne-toi avec notre simulateur IA. Feedback instantané et personnalisé par poste." }
          ].map((step, i) => (
            <div key={i} className="border-2 border-gray-100 rounded-2xl p-8 hover:border-gray-900 transition">
              <div className="text-xs font-bold text-blue-600 tracking-widest mb-4">0{i+1} · {["Profil", "Match", "Prépare"][i]}</div>
      ...
      <section className="bg-gray-900 text-white py-24 px-8 text-center">
        <h2 className="font-syne text-4xl md:text-5xl font-extrabold tracking-tight max-w-2xl mx-auto mb-6 leading-tight">
      ...
      <footer className="border-t border-gray-200 px-8 py-6 flex justify-between items-center flex-wrap gap-4">
        <span className="font-syne font-extrabold text-lg">Kbwee</span>
